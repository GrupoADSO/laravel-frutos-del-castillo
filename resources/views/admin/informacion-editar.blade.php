            ...
            <form action="{{ route('aptualizar-informacion', encrypt($informacion->id)) }}" class="row g-3 control-form" method="GET" enctype="multipart/form-data">
                ...
                <div class="row-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control form__control__input" name="titulo" id="nombre-input" value="{{ $informacion->nombre }}">
                    ...
                    <div class="row g-1">
                        ...
                        <div class="col-6">
                            <textarea class="form-control form__control__input" name="descripcion" id="floatingTextarea">{{ $informacion->descripcion }}</textarea>
                        </div>
