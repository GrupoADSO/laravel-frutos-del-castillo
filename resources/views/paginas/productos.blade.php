...
@section('contenido')
    ...
    <div class="contenedor__titulo">
        ...
        <div class="slider">
            ...
            <div class="word-container">
                <span id="word">Nombre Categoria</span>
            </div>
    ...
    <div id="myModal" class="modal">
        <div class="modal-content-menu">
            ...
            <div class="ladoizq">
                ...
                <!-- <input type="text" class="input-descrip"
                    placeholder="Describe qué te pareció"> -->
            </div>
        </div>
    </div>
    ...
    <div class="cards__menu">
        ...
        <div class="card product">
            ...
            <p class="parrafo__price">$45</p>

            <div class="content__parrafo__agregar">

                <p class="parrafo__cart">Delicioso producto, ven por
                    el tuyo. !No esperes¡</p>

                <a class="add-button" href="#"><svg xmlns="http://www.w3.org/2000/svg" height="50px"
                        viewBox="0 0 512 512">
                        <path
